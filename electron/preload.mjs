...
contextBridge.exposeInMainWorld('dsh', {
  ...
  toolchainStatus: () => ipcRenderer.invoke('dsh:toolchainStatus'),
  installTool: (name) => ipcRenderer.invoke('dsh:installTool', name),
  onToolsProgress: (cb) => subscribe('dsh:toolsProgress', cb),
